...
__all__ = ['resnet','resnet110','resnet56','resnet44','resnet32','resnet20',
            'wresnet20','wresnet32','wresnet44','wresnet110']
...
def wresnet32(**kwargs):
    """Constructs a Wide ResNet-32 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(32, nfilter = [64,128,256], **kwargs)
    return model

def wresnet44(**kwargs):
